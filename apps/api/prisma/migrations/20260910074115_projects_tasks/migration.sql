...
CREATE TABLE "projects" (
    ...
    "statusKey" TEXT NOT NULL DEFAULT 'planned',
...
CREATE TABLE "tasks" (
    ...
    "description" TEXT,
    "assigneeId" TEXT,
    "statusKey" TEXT NOT NULL DEFAULT 'todo',
    "priority" TEXT,
    "dueDate" TIMESTAMP(3),
...
-- CreateIndex
CREATE INDEX "projects_statusKey_idx" ON "projects"("statusKey");
...
-- CreateIndex
CREATE INDEX "tasks_statusKey_idx" ON "tasks"("statusKey");
